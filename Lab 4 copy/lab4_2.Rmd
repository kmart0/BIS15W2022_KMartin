...
```{r}
primate_data <- mammals %>% filter(genus=="Lophocebus"|genus=="Erythrocebus"|genus=="Macaca")%>% select(genus, species, mass, gestation, newborn) %>% print()
```

```{r}
primate_data %>% arrange(newborn)
```
