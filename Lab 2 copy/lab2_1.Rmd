...
chiron<- 261
veyron<- 268
car_group <- c(venom_GT,chiron,veyron)
```
...
It means we can't find the mean if there is missing data. So if there are NAs then you need to address them if you want to use the data in a function.
