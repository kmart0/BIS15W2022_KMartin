...
+ `discrete` quantitative data that only contains integers (1,2,3,4,5)
+ `continuous` quantitative data that can take any numerical value (5.1,5.2,5.3)
+ `categorical` qualitative data that can take on a limited number of values(brown, red, drug A, species)
